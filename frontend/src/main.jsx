  ...
  createRoutesFromElements(
    <>
      <Route path="/" element={<App />}>
        <Route index={true} element={<Suspense fallback={<div>Loading...</div>}><Home /></Suspense>}></Route>
        <Route path="template"element={<Suspense fallback={<div>Loading...</div>}><Template /></Suspense>}></Route>
