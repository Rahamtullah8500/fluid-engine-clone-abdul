const addCustomBlocks = (editor) => {
  ...
  createBlock(
    "1 Section",
    '<section class="block-section"></section>',
    "Sections",
    "",
    "width: 100%; height: 150px;"
  );
  createBlock(
    "1/2 Section",
    '<section class="section"><div class="w-1/2"></div><div class="w-1/2"></div></section>',
    "Sections",
    "",
    "width: 100%; height: 150px;"
  );
  createBlock(
    "1/3 Section",
    '<section class="section"><div class="w-1/3"></div><div class="w-1/3"></div><div class="w-1/3"></div></section>',
    "Sections",
    "",
    "width: 100%; height: 150px;"
  );
  createBlock(
    "3/7 Section",
    '<section class="section"><div class="w-3/7"></div><div class="w-4/7"></div></section>',
    "Sections",
    "",
    "width: 100%; height: 150px;"
  );
  ...
  createBlock(
    "Text Section",
    '<div class="text-section">Text Section</div>',
    "Components",
    "fa fa-file-text",
